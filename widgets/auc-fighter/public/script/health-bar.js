...
var CreateHealthBar = function (pnlHealthbarID, team) {
	...
	HealthBar.prototype.getMax = function () {
		return this.Max;
	};
	HealthBar.prototype.setMax = function (value) {
		this.Max = value;
	};
	HealthBar.prototype.getAmount = function () {
		return this.Amount;
	};
	HealthBar.prototype.setAmount = function (value) {
		this.Amount = value;
	};
	HealthBar.prototype.getCurrentDamage = function () {
		return this.CurrentDamage;
	};
	HealthBar.prototype.setCurrentDamage = function (value) {
		this.CurrentDamage = value;
	};
	HealthBar.prototype.getHealthbarElement = function () {
		return this.HealthbarElement;
	};
	HealthBar.prototype.setHealthbarElement = function (value) {
		this.HealthbarElement = value;
	};
	HealthBar.prototype.getDamageElement = function () {
		return this.DamageElement;
	};
	HealthBar.prototype.setDamageElement = function (value) {
		this.DamageElement = value;
	};
	HealthBar.prototype.getLifeElement = function () {
		return this.LifeElement;
	};
	HealthBar.prototype.setLifeElement = function (value) {
		this.LifeElement = value;
	};
	HealthBar.prototype.getTeam = function () {
		return this.Team;
	};
	HealthBar.prototype.setTeam = function (value) {
		this.Team = value;
	};
	HealthBar.prototype.isInitialized = function () {
		return this.IsInitialized;
	};
	HealthBar.prototype.setInitialized = function (value) {
	...
	HealthBar.prototype.reset = function () {
		...
		if (this.getTeam() == 1) this.DamageElement.style.right = "";
		else if (this.getTeam() == 2) this.DamageElement.style.left = "";
	...
	HealthBar.prototype.change = function (delta) {
		...
		if (!!damage) {
			...
			if (this.getTeam() == 1) this.DamageElement.style.right = offset + "px";
