var CreateAkumaAI = function (player) {
	...
	//private member
	var teleportCloseBackInput_ = [
		{ IsDown: true, Button: BUTTONS.BACK },
		{ IsDown: false, Button: BUTTONS.BACK },
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.BACK },
		{ IsDown: true, Button: BUTTONS.LIGHT_PUNCH },
		{ IsDown: true, Button: BUTTONS.MEDIUM_PUNCH },
		{ IsDown: true, Button: BUTTONS.HARD_PUNCH },
	];
	var teleportFarBackInput_ = [
		{ IsDown: true, Button: BUTTONS.BACK },
		{ IsDown: false, Button: BUTTONS.BACK },
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.BACK },
		{ IsDown: true, Button: BUTTONS.LIGHT_KICK },
		{ IsDown: true, Button: BUTTONS.MEDIUM_KICK },
		{ IsDown: true, Button: BUTTONS.HARD_KICK },
	];
	var teleportCloseFowardInput_ = [
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.FORWARD },
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: true, Button: BUTTONS.LIGHT_PUNCH },
		{ IsDown: true, Button: BUTTONS.MEDIUM_PUNCH },
	...
	//private member
	var lightSuperUppercutInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: false, Button: BUTTONS.FORWARD },
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: 16 },
	];
	var mediumSuperUppercutInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: false, Button: BUTTONS.FORWARD },
		...
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: 32 },
	];
	var hardSuperUppercutInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: false, Button: BUTTONS.FORWARD },
	...
	//private member
	var lightAirSuperFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: false, Button: BUTTONS.FORWARD },
	...
	var mediumAirSuperFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: false, Button: BUTTONS.FORWARD },
	...
	var hardAirSuperFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: false, Button: BUTTONS.FORWARD },
	...
	//private member
	var lightFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: 16 },
	];
	var mediumFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: 32 },
	];
	var hardFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: 64 },
	...
	//private member
	var lightRedFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.LIGHT_KICK },
	];
	var mediumRedFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.MEDIUM_KICK },
	];
	var hardRedFireballInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.HARD_KICK },
	...
	//private member
	var lightJumpRollInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.JUMP },
		{ IsDown: true, Button: BUTTONS.LIGHT_PUNCH },
	];
	var mediumJumpRollInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.FORWARD },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.JUMP },
	...
	//private member
	var lightSKickInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.BACK },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.LIGHT_KICK },
	];
	var mediumSKickInput_ = [
		{ IsDown: true, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.BACK },
		{ IsDown: false, Button: BUTTONS.CROUCH },
		{ IsDown: true, Button: BUTTONS.MEDIUM_KICK },
	...
	AkumaAI.prototype.initCombos = function () {
		...
		this.AI.CounterCloseAttackCombos = [[{ B: "tcf" }], [{ B: "tcf" }]];
		...
		this.AI.CounterFloatCombo = [[{ B: "u3" }], [{ B: "u2" }], [{ B: "u3" }]];
		...
		this.AI.PunishFloatCombo = [[{ B: "su3" }]];
		...
		this.AI.CounterHighFarPendingFloat = [[{ B: "rfb3" }], [{ B: "rfb3" }]];

		this.AI.CounterHighPendingFloat = [[{ B: "fb3" }], [{ B: "fb3" }]];
		...
		this.AI.Airfireballs = [[{ B: "fb1" }], [{ B: "fb2" }], [{ B: "fb3" }]];
	...
	AkumaAI.prototype.doCounterMedAirborneAttackCombo = function (which) {
		this.execute(
			this.AI.CounterMedAirborneAttackCombo[
				which || getRand(this.AI.CounterMedAirborneAttackCombo.length)
			],
		);
	};
	AkumaAI.prototype.doCloseCounterAirborneVulnerableCombo = function (which) {
		this.execute(
			this.AI.CloseCounterAirborneVulnerableCombo[
				which || getRand(this.AI.CloseCounterAirborneVulnerableCombo.length)
			],
		);
	};
	AkumaAI.prototype.doCounterCloseAttackCombos = function (which) {
		this.execute(
			this.AI.CounterCloseAttackCombos[
				which || getRand(this.AI.CounterCloseAttackCombos.length)
			],
		);
	};
	AkumaAI.prototype.doCloseCounterAirborneCombo = function (which) {
		this.execute(
			this.AI.CloseCounterAirborneCombo[
				which || getRand(this.AI.CloseCounterAirborneCombo.length)
			],
		);
	};
	AkumaAI.prototype.doJumpThrustKickComboCombo = function (which) {
		this.execute(
			this.AI.JumpThrustKickCombos[
				which || getRand(this.AI.JumpThrustKickCombos.length)
			],
		);
	};
	AkumaAI.prototype.doVeryCloseCombo = function (which) {
		this.execute(
			this.AI.VeryCloseCombo[which || getRand(this.AI.VeryCloseCombo.length)],
		);
	};
	AkumaAI.prototype.doBehindCombo = function (which) {
		this.execute(
			this.AI.BehindCombos[which || getRand(this.AI.BehindCombos.length)],
		);
	};
	AkumaAI.prototype.doCloseCombo = function (which) {
		this.execute(
			this.AI.CloseCombos[which || getRand(this.AI.CloseCombos.length)],
		);
	};
	AkumaAI.prototype.doCounterFloat = function (which) {
		this.execute(
			this.AI.CounterFloatCombo[
				which || getRand(this.AI.CounterFloatCombo.length)
			],
		);
	};
	AkumaAI.prototype.doCounterFarFloat = function (which) {
		this.execute(
			this.AI.CounterFarFloatCombo[
				which || getRand(this.AI.CounterFarFloatCombo.length)
			],
		);
	};
	AkumaAI.prototype.doCounterHighFloat = function (which) {
		this.execute(
			this.AI.CounterHighFloatCombo[
				which || getRand(this.AI.CounterHighFloatCombo.length)
			],
		);
	};
	AkumaAI.prototype.doCounterCloseFloat = function (which) {
		this.execute(
			this.AI.CounterCloseFloatCombo[
				which || getRand(this.AI.CounterCloseFloatCombo.length)
			],
		);
	};
	AkumaAI.prototype.doCounterHighFarPendingFloat = function (which) {
		this.execute(
			this.AI.CounterHighFarPendingFloat[
				which || getRand(this.AI.CounterHighFarPendingFloat.length)
			],
		);
	};
	AkumaAI.prototype.doCounterHighPendingFloat = function (which) {
		this.execute(
			this.AI.CounterHighPendingFloat[
				which || getRand(this.AI.CounterHighPendingFloat.length)
			],
		);
	};
	AkumaAI.prototype.doAirFireball = function (which) {
		this.execute(
			this.AI.Airfireballs[which || getRand(this.AI.Airfireballs.length)],
		);
	};
	AkumaAI.prototype.doCounterProjectileMoved = function (which) {
		this.execute(
			this.AI.CounterProjectileMoved[
				which || getRand(this.AI.CounterProjectileMoved.length)
			],
		);
	};
	AkumaAI.prototype.doCounterPendingProjectile = function (which) {
		this.execute(
			this.AI.CounterPendingProjectile[
				which || getRand(this.AI.CounterPendingProjectile.length)
			],
		);
	};
	AkumaAI.prototype.doCounterPendingProjectileFar = function (which) {
		this.execute(
			this.AI.CounterPendingProjectileFar[
				which || getRand(this.AI.CounterPendingProjectileFar.length)
			],
		);
	};
	AkumaAI.prototype.doCounterClosePendingProjectile = function (which) {
		this.execute(
			this.AI.CounterClosePendingProjectile[
				which || getRand(this.AI.CounterClosePendingProjectile.length)
			],
		);
	};
	AkumaAI.prototype.doJumpThrustKickCombo = function (which) {
		this.execute(
			this.AI.JumpThrustKickCombos[
				which || getRand(this.AI.JumpThrustKickCombos.length)
			],
	...
	AkumaAI.prototype.doPunishFloat = function (which) {
		if (getRand() > 50) return this.throwSuperFireball(true);
		else return this.doSuperUppercut(true);
	};

	AkumaAI.prototype.getForwardKey = function () {
		this.AI.Player.MustChangeDirection ? BUTTONS.BACK : BUTTONS.FORWARD;
	};
	AkumaAI.prototype.wanderForward = function (nbFrames) {
		this.AI.Actions.push(this.AI.createAction(0, null, fwd_));
		this.AI.Actions.push(this.AI.createAction(nbFrames, FLAGS.CLEAR_INPUT));
	};
	AkumaAI.prototype.wanderBackward = function (nbFrames) {
		this.AI.Actions.push(this.AI.createAction(0, null, bk_));
		this.AI.Actions.push(this.AI.createAction(nbFrames, FLAGS.CLEAR_INPUT));
	};
	...
	AkumaAI.prototype.throwSuperFireball = function (forced) {
		...
		if (energyLevel > 0) {
			if (getRand() > 50 || !!forced) {
				...
				switch (which) {
					case ENERGYBAR.LEVELMAXED:
						this.reset();
						this.doMove("sfb3");
						break;
					case ENERGYBAR.LEVEL2:
						this.reset();
						this.doMove("sfb2");
						break;
					case ENERGYBAR.LEVEL1:
						this.reset();
						this.doMove("sfb1");
						break;
					default:
	...
	AkumaAI.prototype.doJumpThrustKick = function (flags, dist) {
		this.AI.Actions.push(
			this.AI.createAction(
				0,
				FLAGS.JUMP_IN | flags,
				[
					{ IsDown: true, Button: BUTTONS.FORWARD },
	...
	AkumaAI.prototype.getForwardKey = function () {
		return this.AI.Player.MustChangeDirection ? BUTTONS.BACK : BUTTONS.FORWARD;
	};
	AkumaAI.prototype.wanderForward = function (nbFrames) {
		this.AI.Actions.push(this.AI.createAction(0, null, fwd_));
		this.AI.Actions.push(this.AI.createAction(nbFrames, FLAGS.CLEAR_INPUT));
	...
	AkumaAI.prototype.executeThrow = function (which, igoreMoveToEnemy) {
		if (!igoreMoveToEnemy) this.AI.moveToEnemy();
		this.AI.Actions.push(this.AI.createAction(0, null, fwd_));
		if (!which)
			this.AI.Actions.push(this.AI.createAction(0, null, punches_[1]));
		else this.AI.Actions.push(this.AI.createAction(0, null, kicks_[1]));
		this.AI.Actions.push(
			this.AI.createAction(CONSTANTS.ATTACKBUTTON_FRAMES, FLAGS.CLEAR_INPUT),
		);
	};

	AkumaAI.prototype.executeFireball = function (rnd) {
		rnd = rnd || getRand();
		if (!this.AI.Player.isMobile()) return false;
		if (rnd > 66) {
			this.AI.Actions.push(
				this.AI.createAction(0, FLAGS.CLEAR_INPUT, lightFireballInput_),
			);
			this.AI.Actions.push(this.AI.createAction(1, FLAGS.CLEAR_INPUT));
			return true;
		} else {
			this.AI.Actions.push(
				this.AI.createAction(0, FLAGS.CLEAR_INPUT, hardFireballInput_),
			);
			this.AI.Actions.push(this.AI.createAction(1, FLAGS.CLEAR_INPUT));
			return true;
		}
	...
	AkumaAI.prototype.onEnemyAttackPending = function (
		frame,
		x,
		y,
		player,
	...
	AkumaAI.prototype.onEnemyProjectilePending = function (
		frame,
		x,
		y,
		player,
	...
	AkumaAI.prototype.onEnemyProjectileMoved = function (
		frame,
		id,
		x,
		y,
	...
	AkumaAI.prototype.onEnemyContinueAttack = function (
		frame,
		attacker,
		hitPoints,
	) {
		//projectile pending will handle this.
		if (!!attacker.CurrentAnimation.Animation.IsProjectile) return;
		...
		if (!retVal) this.AI.onEnemyContinueAttack(frame, attacker, hitPoints);
	};
	...
	AkumaAI.prototype.reactFloat = function (frame, attacker, x, y) {
		if (!this.AI.Player.isMobile() || this.AI.isAttackReactBusy()) return false;
		if (this.AI.Player.isFacingPlayer(attacker, true)) {
			...
			if (dist.Dsq < 100000 && dist.Dx < 150) {
				this.reset();
				var retVal = false;
				if (dist.Dsq < 50000 && y < 300) retVal = this.doPunishFloat();
				else retVal = this.doCounterFloat();
				if (!retVal) this.doCounterCloseFloat();
				this.AI.setAttackReactBusy();
				return retVal;
	...
	AkumaAI.prototype.reactAirborne = function (
		frame,
		attacker,
		isEnemyVulernerable,
		x,
		...
		if (!this.AI.Player.isBlocking()) {
			if (
				!!this.AI.isAirborneReactBusy() &&
				!!this.AI.Player.isCurrentMoveAttack()
			)
				return true;
		}
		...
		if (
			attacker.CurrentAnimation.Animation.OverrideFlags.hasOverrideFlag(
				OVERRIDE_FLAGS.ALL,
			)
		)
			return true;
	...
	AkumaAI.prototype.reactNotAirborne = function (
		frame,
		attacker,
		isEnemyVulernerable,
		x,
		...
		var retVal = false;
		if (!this.AI.Player.isMobile()) return retVal;
	...
	AkumaAI.prototype.doMove = function (key) {
		this.execute(this.AI.SingleMoves[key]);
	};
	...
	AkumaAI.prototype.execute = function (sequence) {
		...
		for (var i = 0; i < sequence.length; ++i) {
			...
			if (!!mustHit) sequence[i].H = true;
			if (!!autoContinue && sequence[i].AC === undefined) sequence[i].AC = true;

			if (!!sequence[i].MH) mustHit = true;
			if (!!sequence[i].AC) autoContinue = true;
			if (!!sequence[i].SB) forceBusy = true;
            ...
            */
			...
			switch (sequence[i].B) {
				...
				case "get_close": {
					this.AI.moveToEnemy(0, sequence[i].C);
					break;
				}
				case "jump_in": {
					if (
						this.AI.getClosestEnemy().X < (sequence[i].D || this.AI.TOO_CLOSE)
					) {
						return;
					}
					this.AI.jumpInToEnemy(0, sequence[i].C);
					continue;
				}
				case "j": {
					this.AI.jumpUp(undefined, undefined, sequence[i].A);
					continue;
				}
				case "fj": {
					this.AI.jumpTowardEnemy(undefined, undefined, sequence[i].A);
					continue;
				}
				case "bj": {
					this.AI.jumpAwayFromEnemy(undefined, undefined, sequence[i].A);
					continue;
				}
				case "lp1": {
					input = lowPunches_[0];
				...
				case "jr1": {
					input = lightJumpRollInput_;
					break;
				}
				case "jr2": {
					input = mediumJumpRollInput_;
					break;
				}
				case "jr3": {
					input = hardJumpRollInput_;
					break;
				}
				case "fb1": {
					input = lightFireballInput_;
					break;
				}
				case "fb2": {
					input = mediumFireballInput_;
					break;
				}
				case "fb3": {
					input = hardFireballInput_;
					break;
				}
				case "rfb1": {
					input = lightRedFireballInput_;
					break;
				}
				case "rfb2": {
					input = mediumRedFireballInput_;
					break;
				}
				case "rfb3": {
					input = hardRedFireballInput_;
					break;
				}
				case "sfb1": {
					input = lightSuperFireballInput_;
					break;
				}
				case "sfb2": {
					input = mediumSuperFireballInput_;
					break;
				}
				case "sfb3": {
					input = hardSuperFireballInput_;
					break;
				}
				case "su1": {
					input = lightSuperUppercutInput_;
					break;
				}
				case "su2": {
					input = mediumSuperUppercutInput_;
					break;
				}
				case "su3": {
					input = hardSuperUppercutInput_;
					break;
				}
				case "hk1": {
					input = lightSKickInput_;
					break;
				}
				case "hk2": {
					input = mediumSKickInput_;
					break;
				}
				case "hk3": {
					input = hardSKickInput_;
					break;
				}
				case "u1": {
					input = lightUppercutInput_;
					break;
				}
				case "u2": {
					input = mediumUppercutInput_;
					break;
				}
				case "u3": {
					input = hardUppercutInput_;
					break;
				}
				case "t1": {
				...
				case "tff": {
					input = teleportFarForwardInput_;
					break;
				}
				case "tfb": {
					input = teleportFarBackInput_;
					break;
				}
				case "tcf": {
					input = teleportCloseFowardInput_;
					break;
				}
				case "tcb": {
					input = teleportCloseBackInput_;
					break;
				}
				case "jdk": {
					if (
					...
					this.doJumpThrustKick(0, sequence[i].C);
					continue;
				}
				case "jhdk": {
					if (
					...
					this.doJumpThrustHardKick(0, sequence[i].C);
					continue;
				}
				default: {
					this.AI.sendInput(FLAGS.CLEAR_INPUT, sequence[i].A || 0);
					break;
				}
			}
	...
	AkumaAI.prototype.onEnemyDizzy = function (frame, attacker) {
		...
		if (dist.Dx > 400) {
			this.AI.reset();
			if (!this.throwSuperFireball(true)) this.doMove("rfb3");
			this.AI.setBusy();
		} else if (dist.Dx < 100) {
			if (getRand() > 50) this.executeThrow(1, true);
			else this.executeThrow(2, true);
		} else {
			this.doJumpThrustKickComboCombo();
		}
	};

	AkumaAI.prototype.react = function (
		frame,
		attacker,
		isEnemyVulernerable,
		x,
		...
		if (!this.AI.isAttackReactBusy()) {
			if (!this.AI.Player.isMobile()) return;
			if (!!this.reactAirborne(frame, attacker, isEnemyVulernerable, x, y)) {
			} else if (
				!!this.reactNotAirborne(frame, attacker, isEnemyVulernerable, x, y)
			) {
			}
		}
	};
	...
	AkumaAI.prototype.proact = function (frame) {
		if (!this.AI.Player.isMobile() || this.AI.Player.isBlocking()) return;

		if (!!this.AI.isAttackReactBusy()) return;
		...
		if (this.AI.Actions.length != 0) return;

		var dist = this.AI.Player.getDistanceFromPlayer(item.Player);

		if (item.Player.isAirborne()) {
		} else if (
			!item.Player.isMobile() &&
			this.AI.Player.isBehindPlayer(item.Player) &&
			item.Player.isAttacking() &&
			dist.Dsq < 60000
		) {
			...
			if (item.Player.isInThrowableState()) {
				this.AI.reset();
				if (rnd > 50) this.executeThrow(0, true);
				else this.executeThrow(1, true);
				return;
			} else {
				this.AI.reset();
	...
	AkumaAI.prototype.process = function (frame) {
		...
		if (!!this.AI.AllowOverrideBlock) {
			if (!this.AI.Player.isMobile()) {
				if (!!this.AI.JustAttacked) this.AI.JustBecameMobile = 3;
				return;
			}
			...
			this.AI.JustBecameMobile =
				this.AI.JustBecameMobile > 0 ? this.AI.JustBecameMobile - 1 : 0;
		}
	};
