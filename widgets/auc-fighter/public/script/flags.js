...
Flags.prototype.remove = function (value, defaultIfZero) {
	return (this.Value = (this.Value | value) ^ value);
};
Flags.prototype.release = function () {
	this.Owner = null;
};
Flags.prototype.clear = function () {
	this.set(0);
};
Flags.prototype.set = function (value) {
	this.Value = value;
	return this.Value;
};
...
Flags.prototype.has = function (value) {
	return hasFlag(this.Value, value);
};
...
PlayerFlags.prototype.clear = function () {
	for (var i in this) if (!!this[i] && !!this[i].clear) this[i].clear();
};
PlayerFlags.prototype.release = function () {
	this.Owner = null;
	for (var i in this) if (!!this[i] && !!this[i].release) this[i].release();
};
