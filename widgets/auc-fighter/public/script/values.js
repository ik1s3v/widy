...
var makeButtonState = function (state, frame) {
	return { Value: state || BUTTON_STATE.NONE, Frame: frame || 0 };
};
...
var g_slideGap =
	CONSTANTS.SLIDE_BACK_RANGE_FAR - CONSTANTS.SLIDE_BACK_RANGE_NEAR;
var TEXT = {
	HIT_COMBO: "HIT COMBO",
};
