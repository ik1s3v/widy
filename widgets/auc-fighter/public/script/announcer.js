var CreateAnnouncer = function () {
	...
	var round_ = {
		StartFrame: 0,
		IsAnimating: false,
		Element: window.document.getElementById("pnlRound"),
	};
	var roundNumber_ = {
		StartFrame: 0,
		IsAnimating: false,
		Element: window.document.getElementById("pnlRoundNumber"),
	};
	var fight_ = {
		StartFrame: 0,
		IsAnimating: false,
		Element: window.document.getElementById("pnlFight"),
	};
	var ko_ = {
		StartFrame: 0,
		IsAnimating: false,
		Element: window.document.getElementById("pnlKO"),
	};
	var perfect_ = {
		StartFrame: 0,
		IsAnimating: false,
		Element: window.document.getElementById("pnlPerfect"),
	};
	var scf_ = {
		StartFrame: 0,
		IsAnimating: false,
		Element: window.document.getElementById("pnlSuperComboFinish"),
	};
	var frameId_ = 0;
	...
	var Init_ = function () {
        ...
        */
		...
		round_.Animation.addFrame(
			this,
			"|images/misc/misc/round-3.png",
			1,
			0,
			y - 28,
		);
		...
		roundNumber_.Animation.addFrame(
			this,
			"|images/misc/misc/1-0.png",
			1,
			0,
			y - 8,
		);
		...
		fight_.Animation.addFrame(
			this,
			"|images/misc/misc/fight-0.png",
			5,
			0,
			y - 24,
		);
		...
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-0.png",
			4,
			0,
			y,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-1.png",
			4,
			x - 8,
			y + 15,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-2.png",
			4,
			x - 8,
			y + 15,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-3.png",
			4,
			x - 8,
			y + 15,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-4.png",
			4,
			x - 8,
			y + 15,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-5.png",
			4,
			x - 8,
			y + 15,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-6.png",
			4,
			x - 8,
			y + 15,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-7.png",
			4,
			x - 7,
			y + 18,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-8.png",
			4,
			x,
			y + 18,
		);
		perfect_.Animation.addFrame(
			this,
			"|images/misc/misc/perfect-9.png",
			100,
			x,
			y + 18,
		);
	...
	Announcer.prototype.onNewRoundAnnounced = function () {};

	Announcer.prototype.onBeforeNewRoundAnnounced = function () {};

	Announcer.prototype.startRound = function () {
		this.onBeforeNewRoundAnnounced();
		...
		if (match_.getRound() < 10) {
			...
			soundManager_.queueSound(
				"audio/misc/" + match_.getRound() + ".zzz",
				1,
				45,
			);
		} else {
	...
	Announcer.prototype.endRound = function () {
		...
		if (
			match_.getTeamA().getHealthbar().getAmount() == 0 &&
			match_.getTeamB().getHealthbar().getAmount() == 0
		) {
			...
			else soundManager_.queueSound("audio/misc/win.zzz", 1, delay + 35);

			if (
				(showPerfect =
					match_.getTeamB().getHealthbar().getAmount() ==
					match_.getTeamB().getHealthbar().getMax())
			)
			...
			if (
				(showPerfect =
					match_.getTeamA().getHealthbar().getAmount() ==
					match_.getTeamB().getHealthbar().getMax())
			)
				soundManager_.queueSound("audio/misc/perfect.zzz", 1, delay + 95);
		}
	...
	Announcer.prototype.render = function (frame) {
		...
		if (roundNumber_.IsAnimating && roundNumber_.StartFrame <= frame)
			roundNumber_.IsAnimating = roundNumber_.Animation.tryRender(
				frame,
				roundNumber_,
			);
