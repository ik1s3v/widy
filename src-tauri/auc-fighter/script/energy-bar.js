...
var CreateEnergyBar = function (pnlID, team) {
	...
	EnergyBar.prototype.getAmount = function () {
		return amount_;
	};
	EnergyBar.prototype.setAmount = function (value) {
		amount_ = value;
	};
	EnergyBar.prototype.getTeam = function () {
		return team_;
	};
	EnergyBar.prototype.setTeam = function (value) {
		team_ = value;
	};
	EnergyBar.prototype.getParentElement = function () {
		return parentElement_;
	};
	EnergyBar.prototype.setParentElement = function (value) {
		parentElement_ = value;
	};
	EnergyBar.prototype.getBarElement = function () {
		return barElement_;
	};
	EnergyBar.prototype.setBarElement = function (value) {
		barElement_ = value;
	};
	EnergyBar.prototype.getLevel0Element = function () {
		return level0Element_;
	};
	EnergyBar.prototype.setLevel0Element = function (value) {
		level0Element_ = value;
	};
	EnergyBar.prototype.getLevel1Element = function () {
		return level1Element_;
	};
	EnergyBar.prototype.setLevel1Element = function (value) {
		level1Element_ = value;
	};
	EnergyBar.prototype.getLevel2Element = function () {
		return level2Element_;
	};
	EnergyBar.prototype.setLevel2Element = function (value) {
		level2Element_ = value;
	};
	EnergyBar.prototype.getKey = function () {
		return key_;
	};
	EnergyBar.prototype.setKey = function (value) {
		key_ = value;
	};
	EnergyBar.prototype.getStartFrame = function () {
		return startFrame_;
	};
	EnergyBar.prototype.setStartFrame = function (value) {
		startFrame_ = value;
	};
	EnergyBar.prototype.getAnimation = function (value) {
		return animations_[value];
	};
	EnergyBar.prototype.setAnimation = function (index, value) {
		animations_[index] = value;
	};
	EnergyBar.prototype.getAnimations = function () {
		return animations_;
	};
	EnergyBar.prototype.setAnimations = function (value) {
		animations_ = value;
	};
	EnergyBar.prototype.getFrameCount = function () {
		return frameCount_;
	};
	EnergyBar.prototype.setFrameCount = function (value) {
		frameCount_ = value;
	};
	EnergyBar.prototype.getCurrentSrc = function () {
		return currentSrc_;
	};
	EnergyBar.prototype.setCurrentSrc = function (value) {
		currentSrc_ = value;
	};
	EnergyBar.prototype.getLastSrc = function () {
		return lastSrc_;
	};
	EnergyBar.prototype.setLastSrc = function (value) {
		lastSrc_ = value;
	};
	EnergyBar.prototype.isInitialized = function () {
		return isInitialized_;
	};
	EnergyBar.prototype.setInitialized = function (value) {
	...
	EnergyBar.prototype.init = function () {
		...
		if (!this.isInitialized()) {
			...
			level0.addFrame(
				...
				0,
				null,
				"|images/misc/misc/energy-bar-lvl0-team-" + team_ + ".png",
				nbFrames,
			);

			var level0Maxed = this.addAnimation(ENERGYBAR.LEVEL0MAXED_KEY);
			level0Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl0-full-team-" + team_ + "-1.png",
				nbFrames,
			);
			level0Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl0-full-team-" + team_ + "-2.png",
				nbFrames,
			);
			level0Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl0-full-team-" + team_ + "-3.png",
				nbFrames,
			);
			level0Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl0-full-team-" + team_ + "-4.png",
				nbFrames,
			);
			level0Maxed.addFrame(
				this,
			...
			level1Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl1-full-team-" + team_ + "-1.png",
				nbFrames,
			);
			level1Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl1-full-team-" + team_ + "-2.png",
				nbFrames,
			);
			level1Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl1-full-team-" + team_ + "-3.png",
				nbFrames,
			);
			level1Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl1-full-team-" + team_ + "-4.png",
				nbFrames,
			);
			level1Maxed.addFrame(
				this,
			...
			level2Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl2-full-team-" + team_ + "-1.png",
				nbFrames,
			);
			level2Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl2-full-team-" + team_ + "-2.png",
				nbFrames,
			);
			level2Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl2-full-team-" + team_ + "-3.png",
				nbFrames,
			);
			level2Maxed.addFrame(
				this,
				0,
				null,
				"|images/misc/misc/energy-bar-lvl2-full-team-" + team_ + "-4.png",
				nbFrames,
			);
			level2Maxed.addFrame(
				this,
	...
	EnergyBar.prototype.change = function (amount, frame) {
		amount = amount || 0;
		if (
			amount_ < ENERGYBAR.MAX_LEVEL2 &&
			amount_ + amount >= ENERGYBAR.MAX_LEVEL2
		)
			soundManager_.queueSound("audio/misc/lvl3.zzz");

		this.setAmount(
			Math.min(Math.max(amount_ + amount, 0), ENERGYBAR.MAX_LEVEL2),
		);
		this.handleAmountChanged(frame || 0);
	};
	/*css helper*/
	EnergyBar.prototype.showLevelHelper = function (element, cssDisplay) {
		if (element.style.display != cssDisplay) element.style.display = cssDisplay;
	};
	/**/
	EnergyBar.prototype.showEnergyLevelBar = function (level) {
		switch (level) {
			case ENERGYBAR.LEVEL0: {
				this.showLevelHelper(level0Element_, "");
				this.showLevelHelper(level1Element_, "none");
				this.showLevelHelper(level2Element_, "none");
				break;
			}
			case ENERGYBAR.LEVEL1: {
				this.showLevelHelper(level0Element_, "none");
				this.showLevelHelper(level1Element_, "");
				this.showLevelHelper(level2Element_, "none");
				break;
			}
			case ENERGYBAR.LEVEL2: {
				this.showLevelHelper(level0Element_, "none");
				this.showLevelHelper(level1Element_, "none");
				this.showLevelHelper(level2Element_, "");
				break;
			}
			default: {
				this.showLevelHelper(level0Element_, "none");
