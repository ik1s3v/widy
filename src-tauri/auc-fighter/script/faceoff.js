...
var CreateFaceoff = function (match) {
	...
	var Faceoff = function () {
		...
		this.rotateUpFn = (function (max, inc) {
			return function (t, value) {
				return Math.min(value + max / nbFrames, max);
			};
		})(this.MaxAngle);
		this.rotateDownFn = (function (max, inc) {
			return function (t, value) {
				return Math.max(value + max / nbFrames, 0);
			};
		})(this.MaxAngle);
		this.scaleUpFn = (function (max, inc) {
			return function (t, value) {
				return Math.min(value + max / nbFrames, max);
			};
		})(this.MaxScale);
		this.scaleDownFn = (function (max, inc) {
			return function (t, value) {
				return Math.max(value - max / nbFrames, 0);
			};
		})(this.MaxScale);
	...
	Faceoff.prototype.setTeamA = function (name) {
		spriteLookup_.set(
			this.TeamAFaceoffElement,
			"images/misc/misc/p2-select-" + name + ".png",
		);
		spriteLookup_.set(
			this.TeamANameElement,
			"images/misc/font3/name-" + name + ".png",
			false,
			true,
		);
	};
	Faceoff.prototype.setTeamB = function (name) {
		spriteLookup_.set(
			this.TeamBFaceoffElement,
			"images/misc/misc/p2-select-" + name + ".png",
		);
		spriteLookup_.set(
			this.TeamBNameElement,
			"images/misc/font3/name-" + name + ".png",
			false,
			true,
		);
	...
	Faceoff.prototype.resume = function () {
		if (!startedRound_) soundManager_.resume(faceoffSound_);
	};
	...
	Faceoff.prototype.frameMove = function (frame) {
		if (
			frame > CONSTANTS.SHOW_FACEOFF_PICS_DELAY &&
			frame < CONSTANTS.REMOVE_FACEOFF_PICS_DELAY
		) {
	...
	Faceoff.prototype.rotateScale = function () {
		this.TeamAFaceoffElement.style["-webkit-transform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamAFaceoffElement.style["-moz-transform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamAFaceoffElement.style["MozTransform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamAFaceoffElement.style["-o-transform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamAFaceoffElement.style["OTransform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamAFaceoffElement.style["-ms-transform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
		...
		this.TeamBFaceoffElement.style["-webkit-transform"] =
			"scale(" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamBFaceoffElement.style["-moz-transform"] =
			"scale(" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamBFaceoffElement.style["MozTransform"] =
			"scale(" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamBFaceoffElement.style["OTransform"] =
			"scale(" +
			this.Scale +
			"," +
			this.Scale +
			...
			this.Angle +
			"deg)";
		this.TeamBFaceoffElement.style["-ms-transform"] =
			"scale(-" +
			this.Scale +
			"," +
			this.Scale +
