...
var runCharSelectLoop_ = (function (thisValue) {
	return function () {
		thisValue.runCharSelectLoop();
	};
})(game_);

var runInsertCoinScreenLoop_ = (function (thisValue) {
	return function () {
		thisValue.runInsertCoinScreenLoop();
	};
})(game_);
...
var btn = function (button, state, min, max) {
	return {
		Button: button,
		State: state,
		MinNbFrames: min || undefined,
		MaxNbFrames: max || undefined,
	};
};
...
function InitUsers() {
	...
	// window.user1_ = game_.addUser1(GAMEPAD.RIGHT,GAMEPAD.UP,GAMEPAD.LEFT,GAMEPAD.DOWN,GAMEPAD.LS0,GAMEPAD.B3,GAMEPAD.B2,GAMEPAD.RS0,GAMEPAD.B1,GAMEPAD.HK,GAMEPAD.RS1,GAMEPAD.SELECT,GAMEPAD.START,0);
	window.user2_ = game_.addUser2(
		KEYS.NUMPAD_6,
		KEYS.NUMPAD_8,
		KEYS.NUMPAD_4,
		KEYS.NUMPAD_5,
...
stuffLoader_.queue(
	"images/misc/misc/announcer-sprites.png",
...
stuffLoader_.queue(
	"images/misc/misc/energy-bar-lvl0.png",
	RESOURCE_TYPES.IMAGE,
);
stuffLoader_.queue(
	"images/misc/misc/energy-bar-lvl1.png",
	RESOURCE_TYPES.IMAGE,
);
stuffLoader_.queue(
	"images/misc/misc/energy-bar-lvl2.png",
	RESOURCE_TYPES.IMAGE,
);
stuffLoader_.queue(
	"images/misc/misc/health-bar-life.png",
	RESOURCE_TYPES.IMAGE,
);
stuffLoader_.queue(
	"images/misc/misc/health-bar-damage.png",
	RESOURCE_TYPES.IMAGE,
);
stuffLoader_.queue("images/misc/misc/misc-sprites.png", RESOURCE_TYPES.IMAGE);
...
stuffLoader_.queue(
	"images/misc/misc/char-select-sprites.png",
	RESOURCE_TYPES.IMAGE,
);
...
var startUpGame = function () {
	...
	debug_.startMatch(
		[{ A: CHARACTERS.RYU, C: true }],
		[{ A: CHARACTERS.AKUMA, C: true }],
		"akuma",
		function () {},
	);
	return game_;
